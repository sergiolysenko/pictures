...
const createPictureTemplate = (picture) => {
  ...
  <div class="grid">
    <div class="w-full h-80 relative">
      <button class="edit w-20 h-20 sm:w-5 sm:h-7 absolute flex items-center justify-center right-20 bottom-20 z-20 ${isChangeable ? "" : "hidden"}">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 383.947 383.947">
        ...
        <svg fill="white" class="height="20" width="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 130">
          <path stroke="white" d="M87.5 111l-47-47m0 0l47-47" stroke-width="15"></path>
        </svg>
      </button>

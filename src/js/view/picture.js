  ...
  <div class="grid">
    <div class="w-full h-80 relative">
      <button class="edit w-7 h-7 sm:w-5 sm:h-7 absolute flex items-center justify-center right-4 bottom-4 z-20 ${isChangeable ? "" : "hidden"}">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 383.947 383.947" style="enable-background:new 0 0 383.947 383.947;" xml:space="preserve">
